/*
  ...
  1. New Tables
    - `assessment_results` - Store AI readiness assessment results and recommendations
    - `time_tracking_sessions` - Track individual time tracking sessions with AI savings potential
    - `habit_completions` - Record daily habit completions with quality ratings
    - `user_gamification` - Store user XP, levels, streaks, and achievements
    - `workflow_templates` - User-created and shared workflow templates

  2. Security
    - Enable RLS on all new tables
    - Add policies for users to manage their own data
    - Allow public read access for shared workflow templates
...
-- Insert some sample workflow templates for demonstration
INSERT INTO workflow_templates (id, creator_id, title, description, workflow_data, category, is_public, rating, rating_count, tags) VALUES
(
  'wf-email-automation',
